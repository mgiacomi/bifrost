...
If implementation reveals Java-to-Go boundary work beyond the plan's approved coordination scope, treat that as a plan mismatch. Do not ship a boundary change without its required Java or Go counterpart, protocol fixtures, semantic tests, rejection tests, and documentation.
