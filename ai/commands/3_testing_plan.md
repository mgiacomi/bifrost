...
When the work affects the Loomspan Console application-adapter REST/SSE, acquisition, problem, or consumed NDJSON boundary, carry forward the approved Java-to-Go boundary-coordination scope and cover the affected executable fixtures, exact release-string rejection, and observable semantics.
