...
- Reserve `/_loomspan/observability/v1/**` and fail safely on route collision.
- Authenticate `X-loomspan-Api-Key` and establish the sole operator authority.
...
- Missing Loomspan credentials and upstream/host rejection remain distinguishable.
