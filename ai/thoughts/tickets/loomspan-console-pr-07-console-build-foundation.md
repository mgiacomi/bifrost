...
Create the independent `loomspan-console/` Go module and embedded React
...
- Inject the complete Loomspan product version and test stale/missing assets.
- Add local development hot reload with loopback Vite and a narrowly scoped
  proxy to Go.

## Guardrails

- The console is not a Maven module or continuation of `loomspan-cli`.
