...
class ObservabilityHostSecurityIntegrationTest
{
    ...
    @Test
    void hostPassThroughStillRequiresBifrostKeyAndBusinessRoutesStayHostOwned() throws Exception
    {
        ...
        assertThat(missingKey.body()).contains("\"code\":\"BIFROST_API_KEY_REJECTED\"");
        assertThat(validKey.statusCode()).isEqualTo(200);
        assertThat(business.statusCode()).isIn(401, 403);
        assertThat(business.body()).doesNotContain("BIFROST_API_KEY_REJECTED");
        ...
        assertThat(forwarded.body()).contains("\"code\":\"BIFROST_API_KEY_REJECTED\"");
    }
