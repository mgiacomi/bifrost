...
class ToolCallbackFactoryTest {
    ...
    void routesMappedExecutionsThroughPublicTraceIdentity() {
        ...
        ExecutionFrame toolFrame = new ExecutionFrame(
                "tool-frame-1",
                null,
                com.lokiscale.bifrost.internal.core.OperationType.SKILL,
        ...
        ExecutionPlan linkedPlan = new ExecutionPlan(
                ...
                "rootVisibleSkill",
                Instant.parse("2026-03-15T12:00:00Z"),
                com.lokiscale.bifrost.internal.core.PlanStatus.VALID,
                "task-1",
    ...
    void resolvesRefArgumentsBeforeDeterministicExecution() {
        ...
        CapabilityExecutionRouter router = new CapabilityExecutionRouter(
                refResolver,
                new StaticListableBeanFactory().getBeanProvider(com.lokiscale.bifrost.internal.core.ExecutionCoordinator.class),
                stateService,
    ...
    private static com.lokiscale.bifrost.internal.skill.YamlSkillDefinition definitionWithEvidenceContract() {
