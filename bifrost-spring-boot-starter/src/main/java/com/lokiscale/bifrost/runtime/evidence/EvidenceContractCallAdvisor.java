...
public final class EvidenceContractCallAdvisor implements CallAdvisor {
    ...
    private final java.util.function.Consumer<EvidenceCoverageResult> passRecorder;
    private final java.util.function.Consumer<EvidenceCoverageResult> failRecorder;
    ...
    public EvidenceContractCallAdvisor(String skillName,
                                       ...
                                       int maxRetries,
                                       java.util.function.Consumer<EvidenceCoverageResult> passRecorder,
                                       java.util.function.Consumer<EvidenceCoverageResult> failRecorder,
