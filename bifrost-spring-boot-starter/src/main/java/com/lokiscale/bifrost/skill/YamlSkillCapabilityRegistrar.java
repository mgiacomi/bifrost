...
public class YamlSkillCapabilityRegistrar implements SmartInitializingSingleton {
    ...
    public void afterSingletonsInstantiated() {
        for (YamlSkillDefinition definition : yamlSkillCatalog.getSkills()) {
            ...
            com.lokiscale.bifrost.runtime.input.SkillInputContract inputContract = resolveInputContract(definition, target);
    ...
    private CapabilityToolDescriptor resolveToolDescriptor(YamlSkillDefinition definition,
                                                           CapabilityMetadata target,
                                                           com.lokiscale.bifrost.runtime.input.SkillInputContract inputContract) {
    ...
    private com.lokiscale.bifrost.runtime.input.SkillInputContract resolveInputContract(YamlSkillDefinition definition,
                                                                                        CapabilityMetadata target) {
