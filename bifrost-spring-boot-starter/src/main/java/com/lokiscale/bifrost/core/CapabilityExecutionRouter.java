...
public class CapabilityExecutionRouter {
    ...
    public CapabilityExecutionRouter(RefResolver refResolver,
        ...
        this(refResolver, executionCoordinatorProvider, new ObjectMapper(), executionStateService, accessGuard, new SkillInputValidator());
    }
    ...
    public CapabilityExecutionRouter(RefResolver refResolver,
                                     ...
                                     ExecutionStateService executionStateService,
                                     AccessGuard accessGuard) {
        this(refResolver, executionCoordinatorProvider, objectMapper, executionStateService, accessGuard, new SkillInputValidator());
    }
