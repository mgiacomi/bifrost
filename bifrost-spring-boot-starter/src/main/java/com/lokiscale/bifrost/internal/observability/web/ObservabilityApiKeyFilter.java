...
{
    public static final String API_KEY_HEADER = "X-Bifrost-Api-Key";
    public static final String INSTANCE_HEADER = "X-Bifrost-Instance-Id";
        ...
        try
        {
                    ...
                    presented.getBytes(StandardCharsets.UTF_8), configured.getBytes(StandardCharsets.UTF_8)))
            {
                writeProblem(httpResponse, new ObservabilityProblem(
                        401, ObservabilityProblem.Code.BIFROST_API_KEY_REJECTED, "Bifrost API key was rejected"), false);
                return;
            }
            ...
            LOGGER.debug("Authenticated Bifrost observability operator");
            ...
            catch (Exception failure)
            {
                ...
                {
                    LOGGER.warn(
                            "Bifrost observability request failed exceptionClass={}",
