...
{
    public static final String REQUEST_CONTEXT_KEY = "bifrost.model-trace.context";
    public static final String RESPONSE_ATTEMPT_CONTEXT_KEY = "bifrost.model-trace.attempt";
