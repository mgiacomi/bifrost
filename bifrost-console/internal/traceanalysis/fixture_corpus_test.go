...
// fixtureRoot locates the bifrost-console-fixtures directory without copying
...
func fixtureRoot(t *testing.T) string {
	...
	candidates := []string{
		filepath.Join(cwd, "..", "..", "bifrost-console-fixtures"),
		filepath.Join(cwd, "..", "..", "..", "bifrost-console-fixtures"),
	}
	...
	t.Fatalf("bifrost-console-fixtures not found relative to %s", cwd)
	return ""
}
