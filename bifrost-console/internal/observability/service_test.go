...
func TestObservabilityServiceReturnsActivePageWithResumeCursorFromFixture(t *testing.T) {
	fixture, err := os.ReadFile(filepath.Join("..", "..", "..", "bifrost-console-fixtures", "application-rest", "active-executions-page.json"))
	if err != nil {
		t.Fatal(err)
	}
	client := &fakeGetClient{body: fixture, instanceID: "11111111-1111-4111-8111-111111111111"}
...
func TestObservabilityServiceReturnsTracePageFromFixture(t *testing.T) {
	fixture, err := os.ReadFile(filepath.Join("..", "..", "..", "bifrost-console-fixtures", "application-rest", "traces-page.json"))
	if err != nil {
		t.Fatal(err)
	}
	client := &fakeGetClient{body: fixture, instanceID: "11111111-1111-4111-8111-111111111111"}
...
func TestObservabilityServiceReturnsSkillDetailFromFixture(t *testing.T) {
	fixture, err := os.ReadFile(filepath.Join("..", "..", "..", "bifrost-console-fixtures", "application-rest", "skill-detail.json"))
	if err != nil {
		t.Fatal(err)
	}
	client := &fakeGetClient{body: fixture, instanceID: "11111111-1111-4111-8111-111111111111"}
...
func TestObservabilityServiceReturnsActiveExecutionDetailFromFixture(t *testing.T) {
	fixture, err := os.ReadFile(filepath.Join("..", "..", "..", "bifrost-console-fixtures", "application-rest", "active-execution-detail.json"))
	if err != nil {
		t.Fatal(err)
	}
	client := &fakeGetClient{body: fixture, instanceID: "11111111-1111-4111-8111-111111111111"}
...
func TestObservabilityServiceReturnsTraceDetailFromFixture(t *testing.T) {
	fixture, err := os.ReadFile(filepath.Join("..", "..", "..", "bifrost-console-fixtures", "application-rest", "trace-detail.json"))
	if err != nil {
		t.Fatal(err)
	}
	client := &fakeGetClient{body: fixture, instanceID: "11111111-1111-4111-8111-111111111111"}
