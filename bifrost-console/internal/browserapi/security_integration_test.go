...
func TestPairingBootstrapAndProtectedPairingLink(t *testing.T) {
	...
	linkRequest.Header.Set("X-Bifrost-Console-Tab", state.TabID)
	...
	heartbeatRequest.Header.Set("X-Bifrost-Console-Tab", state.TabID)
...
func TestPairingLinkRequiresOriginSessionAndCSRFIndependently(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			request.Header.Set("X-Bifrost-Console-Tab", state.TabID)
