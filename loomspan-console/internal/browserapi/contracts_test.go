...
func TestBrowserTraceAnalysisFixtureCorpusMatchesCommittedInventoryByteForByte(t *testing.T) {
	...
	expected := map[string]any{
		"summary.json":                   summaryDTO{TargetScopeID: scope, TraceID: "trace-1", SessionID: "session-1", Outcome: "FAILED", ConfiguredLimits: &configuredLimitsDTO{MaxSkillInvocations: 7, MaxToolInvocations: 11, MaxLinterRetries: 3, MaxModelCalls: 5, MaxUsageUnits: 1234}, RecordCount: 4, FrameCount: 1, RootFrameIDs: []string{}, UsageComplete: false},
